...
const Checkout: React.FC = () => {
  ...
  if (orderPlaced) {
    return (
      <Layout>
        <SEO title="Order Confirmation | Mansara Foods" noindex url="https://www.mansarafoods.com/checkout" />
  ...
  if (items.length === 0) {
    return (
      <Layout>
        <SEO title="Checkout | Mansara Foods" noindex url="https://www.mansarafoods.com/checkout" />
        <section className="py-20 bg-background">
